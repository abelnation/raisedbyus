		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span-one-third">
					<p>A workplace giving  program for techies that allows employees to give a little bit of their paycheck to the charity of their choice.</p>
					<a href="getinvolved.html"><img src="img/button_get_involved.png" alt="get involved" /></a>
				</div>
			</div>
			</section>
		...
		<div class="container">
			...
			<div class="row">
				<div class="span16">
					<h3>Causes</h3>
					<div id="donor-logos">
						<a href="" class="donor"><img src="img/causes_charitywater.png" alt="charity water" /></a>
						<a href="" class="donor"><img src="img/causes_americanredcross.png" alt="american red cross" /></a>
						<a href="" class="donor"><img src="img/causes_donorschoose.png" alt="donors choose" /></a>
					</div>
					<a id="see-all-causes" href="/causes.html">See All Causes</a>
				</div>	
			</div>
			</section>
